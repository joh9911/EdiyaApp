...
class ShoppingBasketDeleteFragment: Fragment() {
        ...
        val serviceConnection = object : ServiceConnection {
            override fun onServiceConnected(p0: ComponentName?, p1: IBinder?) {
                Log.d("ShoppingBasketDeleteFragment 내의 onServiceConneced", " 실행되나?")
        ...
        override fun onCreateView(
            ...
            val view = inflater.inflate(R.layout.shopping_baskcet_delete_fragment, container, false)
            serviceBind()
        ...
        fun serviceBind() {
            ...
            Log.d("ShoppingDeleteBasket 내의 serviceBind", "난 서비스 실행했음")
        }
        ...
        fun serviceUnBind() {
            if (isConService) {
                ...
                isConService = false
                Log.d("ShoppingDeleteBasket 내의 serviceUnBind", "난 서비스 껏음")
            }
        ...
        fun addCustomView(shoppingList: ArrayList<ArrayList<String>>){
            ...
            for(index in 0 until shoppingList.size) {
                val customView = layoutInflater.inflate(
                    R.layout.shopping_basket_delete_custom_view,
                    linearLayout,
                    false
                )
